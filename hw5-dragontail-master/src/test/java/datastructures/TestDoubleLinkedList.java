...
public class TestDoubleLinkedList extends BaseTest {
    ...
    @Test(timeout = SECOND)
    public void testDeleteAtMiddleAndSize() {
        IList<String> list = makeBasicList();
    ...
    @Test(timeout = SECOND)
    public void testDeleteAtEndAndSize() {
        IList<String> list = makeBasicList();
        int initSize = list.size();
    ...
    @Test(timeout=SECOND)
    public void testDeleteThrowsIndexOutOfBoundsException() {
        IList<String> list = makeBasicList();
        try {
    ...
    @Test(timeout=5*SECOND)
    public void testAddAndDeleteAtEndIsEfficient() {
        IList<Integer> list = new DoubleLinkedList<Integer>();
        int cap = 500000;
        for (int i = 0; i < cap; i++) {
            list.add(i);
    ...
    @Test(timeout=5*SECOND) 
    public void testAddAndDeleteNearMiddleIsEfficient() { 
        IList<Integer> list = new DoubleLinkedList<Integer>();
        int cap = 50000;
        for (int i = 0; i < cap; i++) {
            list.add(i);
    ...
    public void testAddAndDeleteMultiple() {
        ...
        assertEquals("b", list.delete(list.size() - 1));
        this.assertListMatches(new String[] {"a"}, list);
        
        assertEquals("a", list.delete(list.size() - 1));
        this.assertListMatches(new String[] {}, list);
    }

    @Test(timeout=1*SECOND)
    public void testAddAndDeleteWithNull() {
        IList<String> list = new DoubleLinkedList<String>();
        list.add(null);
        list.add("Hello");
        assertEquals(2, list.size());
    ...
    @Test(timeout=1*SECOND)
    public void testAddAndDeleteWithEmpty() {
        IList<String> list = new DoubleLinkedList<String>();
        list.add("");
        assertEquals(1, list.size());
        assertEquals("", list.delete(0));
        assertEquals(0, list.size());        
    }
